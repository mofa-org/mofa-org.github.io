...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"introducing-mofa-copy":"/src/content/blog/introducing-mofa copy.md","introducing-mofa":"/src/content/blog/introducing-mofa.md"}},"docs":{"type":"content","entries":{"1-concepts/agents":"/src/content/docs/1. concepts/agents.md","0overview":"/src/content/docs/0.overview.md","2-getting-started/first-agent":"/src/content/docs/2. getting-started/first-agent.md","2-getting-started/installation":"/src/content/docs/2. getting-started/installation.md","3-test/first-agent":"/src/content/docs/3. test/first-agent.md","3-test/installation":"/src/content/docs/3. test/installation.md","3-test2/first-agent":"/src/content/docs/3. test2/first-agent.md","3-test2/installation":"/src/content/docs/3. test2/installation.md"}}};
