...
import 'clsx';
/* empty css                           *//* empty css                          */import { $ as $$BaseLayout, g as getCollection } from './_...slug_.astro.bed0ebb5.js';
/* empty css                          */
const $$WorkflowShowcase = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="py-20" style="background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%);" data-astro-cid-22cdqia5> <div class="container mx-auto px-4" data-astro-cid-22cdqia5> <div class="text-center mb-16" data-astro-cid-22cdqia5> <h2 class="text-4xl font-bold mb-4" data-en="Real Examples: <span class='gradient-text'>AI Workflows</span> in Action" data-zh="实际案例：<span class='gradient-text'>AI 数据流</span>实战" data-astro-cid-22cdqia5>
Real Examples: <span class="gradient-text" data-astro-cid-22cdqia5>AI Dataflows</span> in Action
</h2> <p class="text-xl text-gray-600 max-w-3xl mx-auto" data-en="Explore different types of AI workflows - from simple hello world to complex research automation" data-zh="探索不同类型的 AI 数据流 - 从简单的Hello World到复杂的研究自动化" data-astro-cid-22cdqia5>
