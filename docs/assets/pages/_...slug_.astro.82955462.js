...
const $$DocsLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title, "description": description, "data-astro-cid-mw7aashj": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div style="display: flex; min-height: calc(100vh - 140px);" data-astro-cid-mw7aashj> <!-- 左侧侧边栏 --> <aside style="width: 280px; background: #f8fafc; border-right: 1px solid #e5e7eb; padding: 32px 0; flex-shrink: 0; overflow-y: auto; max-height: calc(100vh - 140px); position: sticky; top: 140px;" data-astro-cid-mw7aashj> <div style="padding: 0 24px;" data-astro-cid-mw7aashj> <h2 style="font-size: 1.125rem; font-weight: 700; color: #111827; margin: 0 0 24px 0;" data-astro-cid-mw7aashj>
Documentation
