const id = "3. examples/hello-world.md";
						const collection = "docs";
						const slug = "3-examples/hello-world";
						...
						const data = {title:"Hello World Example",description:"The simplest MoFA agent example - Hello World"};
						const _internal = {
							type: 'content',
							filePath: "/Users/liyao/Code/mofa-org.github.io/mofa-website/src/content/docs/3. examples/hello-world.md",
